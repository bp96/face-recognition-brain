...
class App extends Component {
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://facerecognitionwebsiteapi.herokuapp.com/imageurl', { // URL: http://localhost:3001/imageurl
            method: 'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://facerecognitionwebsiteapi.herokuapp.com/image', { // URL: http://localhost:3001/image
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
            ...
            .then(count => {
              ...
              } else {this.setState(Object.assign(this.state.user, { entries: count}))}
            })
